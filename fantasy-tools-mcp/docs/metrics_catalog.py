metrics_catalog = {
    "receiving": {
        ...
        "efficiency_metrics": {
            ...
            "fields": {
                ...
                "targets_pctile": "Positional percentile rank for targets (0-100, partitioned by position and season)",
                "target_share_pctile": "Positional percentile rank for target share (0-100, partitioned by position and season)",
                "receiving_yards_pctile": "Positional percentile rank for receiving yards (0-100, partitioned by position and season)",
                "fantasy_points_ppr_pctile": "Positional percentile rank for PPR fantasy points (0-100, partitioned by position and season)",
                "catch_percentage_pctile": "Positional percentile rank for catch percentage (0-100, partitioned by position and season)",
                "avg_yac_pctile": "Positional percentile rank for average yards after catch (0-100, partitioned by position and season)",
            },
        },
        "situational_metrics": {
    ...
    "passing": {
        ...
        "efficiency_metrics": {
            ...
            "fields": {
                ...
                "passing_yards_pctile": "Positional percentile rank for passing yards (0-100, partitioned by position and season)",
                "passing_tds_pctile": "Positional percentile rank for passing touchdowns (0-100, partitioned by position and season)",
                "passer_rating_pctile": "Positional percentile rank for passer rating (0-100, partitioned by position and season)",
                "completion_percentage_pctile": "Positional percentile rank for completion percentage (0-100, partitioned by position and season)",
                "epa_total_pctile": "Positional percentile rank for total EPA (0-100, partitioned by position and season)",
                "fantasy_points_ppr_pctile": "Positional percentile rank for PPR fantasy points (0-100, partitioned by position and season)",
            },
        },
        "situational_metrics": {
    ...
    "rushing": {
        ...
        "efficiency_metrics": {
            ...
            "fields": {
                ...
                "carries_pctile": "Positional percentile rank for carries (0-100, partitioned by position and season)",
                "rushing_yards_pctile": "Positional percentile rank for rushing yards (0-100, partitioned by position and season)",
                "rushing_tds_pctile": "Positional percentile rank for rushing touchdowns (0-100, partitioned by position and season)",
                "rushing_epa_pctile": "Positional percentile rank for rushing EPA (0-100, partitioned by position and season)",
                "fantasy_points_ppr_pctile": "Positional percentile rank for PPR fantasy points (0-100, partitioned by position and season)",
                "avg_rush_yards_pctile": "Positional percentile rank for average yards per carry (0-100, partitioned by position and season)",
            },
        },
        "situational_metrics": {
    ...
    "defense": {
        ...
        "efficiency_metrics": {
            ...
            "fields": {
                ...
                "sk_pctile": "Positional percentile rank for sacks (0-100, partitioned by position and season)",
                "int_pctile": "Positional percentile rank for interceptions (0-100, partitioned by position and season)",
                "comb_pctile": "Positional percentile rank for combined tackles (0-100, partitioned by position and season)",
                "prss_pctile": "Positional percentile rank for pressures (0-100, partitioned by position and season)",
                "cmp_percent_pctile": "Positional percentile rank for completion percentage allowed (0-100, partitioned by position and season; lower completion % is better so uses DESC ordering)",
            },
        },
        "situational_metrics": {
    ...
    "consistency": {
        "basic_info": {
            "description": "Basic identifying information included with every consistency query.",
            "fields": {
                "season": "NFL season (year)",
                "player_name": "Player's full name",
                "ff_position": "Fantasy football position",
                "ff_team": "Fantasy football team abbreviation",
            },
        },
        "consistency_metrics": {
            "description": "Week-to-week variance and reliability metrics for fantasy performance.",
            "fields": {
                "games_played": "Number of games included in consistency calculation (minimum 4 required)",
                "avg_fp_ppr": "Average weekly fantasy points in PPR scoring",
                "fp_stddev_ppr": "Standard deviation of weekly fantasy points (volatility measure)",
                "fp_floor_p10": "10th percentile weekly score (floor — worst-case typical week)",
                "fp_ceiling_p90": "90th percentile weekly score (ceiling — best-case typical week)",
                "fp_median_ppr": "Median weekly fantasy points (50th percentile)",
                "boom_games_20plus": "Number of games scoring 20+ PPR points (boom games)",
                "bust_games_under_5": "Number of games scoring fewer than 5 PPR points (bust games)",
                "consistency_coefficient": "Standard deviation divided by mean (lower = more consistent, typical range 0.2-1.0)",
            },
        },
    },
}
