...
class League(BaseApi):
    ...
    def __init__(self, league_id: str | int) -> None:
        ...
        self._base_url = f"https://api.sleeper.app/v1/league/{self.league_id}"
    ...
    def get_matchups(self, week: str | int) -> list:
    ...
    def get_scoreboards(
        self, rosters: list, matchups: list, users: list, score_type: str, season: str | int, week: str | int
    ) -> dict | None:
        ...
        for team in matchups:
            ...
            team_name = users_dict[owner_id] if owner_id is not None else "Team name not available"
    ...
    def get_team_score(self, starters: list, score_type: str, season: str | int, week: str | int) -> float:
    ...
    def empty_roster_spots(self, user_id: str | int) -> int | None:
    ...
    def get_negative_scores(self, week: str | int) -> None:
        pass
...
def get_sport_state(sport: str = "nfl") -> dict:
    ...
    """
    return BaseApi()._call(f"https://api.sleeper.app/v1/state/{sport}")
