...
class User(BaseApi):
    ...
    def __init__(self, initial_user_input: str | int) -> None:
        ...
        self._user = self._call(f"{self._base_url}/{initial_user_input}")
    ...
    def get_all_leagues(self, sport: str, season: str | int) -> list:
    ...
    def get_all_drafts(self, sport: str, season: str | int) -> list:
