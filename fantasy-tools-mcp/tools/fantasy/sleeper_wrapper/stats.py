...
class Stats(BaseApi):
    ...
    def get_all_stats(self, season_type: str, season: str | int) -> dict:
        ...
        return self._call(f"{self._base_url}/{season_type}/{season}")

    def get_week_stats(self, season_type: str, season: str | int, week: str) -> dict:
        ...
        """
        return self._call(f"{self._base_url}/{season_type}/{season}/{week}")

    def get_all_projections(self, season_type: str, season: str | int) -> dict:
        ...
        """
        return self._call(f"{self._projections_base_url}/{season_type}/{season}")

    def get_week_projections(self, season_type: str, season: str | int, week: str) -> dict:
        ...
        Returns:
          A dictionary with each player and their projections for the year.
        """
        return self._call(f"{self._projections_base_url}/{season_type}/{season}/{week}")
